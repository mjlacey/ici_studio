...
use super::{linear, table_lookup, text, bitfield};
...
impl ConversionBlock {
    ...
    pub fn apply_decoded(
        ...
        match self.cc_type {
            ...
            ConversionType::TableLookupInterp => table_lookup::apply_table_lookup(self, value, true),
            ConversionType::TableLookupNoInterp => table_lookup::apply_table_lookup(self, value, false),
